...
{ JOB_ABYSSAL_KNIGHT, {
    ...
    { "leather armour" },
    WCHOICE_PLAIN,
    { { SK_FIGHTING, 24}, { SK_SHORT_BLADES, 24}, { SK_LONG_BLADES, 24},
      { SK_AXES, 24}, { SK_MACES_FLAILS, 24}, { SK_POLEARMS, 24},
      { SK_STAVES, 24}, { SK_SLINGS, 24}, { SK_BOWS, 24}, { SK_CROSSBOWS, 24},
      { SK_THROWING, 24}, { SK_ARMOUR, 24}, { SK_DODGING, 24}, { SK_STEALTH, 24},
      { SK_SHIELDS, 24}, { SK_UNARMED_COMBAT, 24}, { SK_SPELLCASTING, 24},
      { SK_CONJURATIONS, 24}, { SK_HEXES, 24}, { SK_CHARMS, 24},
      { SK_SUMMONINGS, 24}, { SK_NECROMANCY, 24}, { SK_TRANSLOCATIONS, 24},
      { SK_TRANSMUTATIONS, 24}, { SK_FIRE_MAGIC, 24}, { SK_ICE_MAGIC, 24},
      { SK_AIR_MAGIC, 24}, { SK_EARTH_MAGIC, 24}, { SK_POISON_MAGIC, 24},
      { SK_INVOCATIONS, 24}, { SK_EVOCATIONS, 24}, },
} },
